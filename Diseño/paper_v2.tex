...
%%%% Nota: lo dejo comentado porque me parece que no hace falta mencionarlo ya que en los diagramas viene el número de página y el nombre, y además se agregan en orden. Es más que todo para ahorrar espacio
\begin{comment}
